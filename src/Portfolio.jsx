...
import { Download, Mail, MapPin, Twitter, Linkedin, ExternalLink, ArrowRight, ArrowUpRight, Phone, Instagram, Github } from 'lucide-react';
  ...
  {/* Links Row */}
          <div className="flex justify-between items-center border-t border-gray-800 pt-3 text-sm">
            ...
            <div className="flex items-center gap-6">
              ...
              <a
                href="https://github.com/Ashmitgarg18"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-gray-400 hover:text-white transition-colors no-underline"
              >
              ...
              <a
                href="https://leetcode.com/u/gargashmit09/"
                target="_blank"
                rel="noopener noreferrer"
    ...
    {/* Footer */}
        <footer className="py-12 px-6 border-t border-gray-800">
          <div className="max-w-7xl mx-auto text-center text-gray-500">
            <p>© 2025 Ashmit Garg. All rights reserved.</p>
          </div>
        </footer>
      </div>
      );
